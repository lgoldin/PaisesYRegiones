    ...
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/jqueryui").Include(
                        "~/Scripts/i18n/jquery.ui.datepicker-es.js",
                        "~/Scripts/jquery-ui-1.10.4.js",
                        "~/Scripts/jquery.showdialog.js",
            ...
            bundles.Add(new ScriptBundle("~/bundles/jqgrid").Include(
                        ...
                        "~/Scripts/jqgrid-fixgridwidth.js"));

            bundles.Add(new ScriptBundle("~/bundles/pollyfills").Include(
            ...
            bundles.Add(new StyleBundle("~/Content/themes/custom-theme/css").Include(
                        "~/Content/themes/custom-theme/jquery-ui-1.9.2.custom.css"));
